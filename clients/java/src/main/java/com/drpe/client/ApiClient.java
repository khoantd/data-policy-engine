...
import com.drpe.client.auth.Authentication;
import com.drpe.client.auth.HttpBasicAuth;
import com.drpe.client.auth.HttpBearerAuth;
import com.drpe.client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "http://localhost:8000";
     ...
     * @return a {@link com.drpe.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.drpe.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.drpe.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.drpe.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.drpe.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.drpe.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.drpe.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.drpe.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.drpe.client.ApiException If fail to serialize the request body object into a string
     */
