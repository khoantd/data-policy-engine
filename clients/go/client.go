...
// APIClient manages communication with the DRPE — Data Retention Policy Engine API v0.1.0
...
type APIClient struct {
	...
	ClassifyAPI *ClassifyAPIService

	DsarAPI *DsarAPIService

	EnforceAPI *EnforceAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ClassifyAPI = (*ClassifyAPIService)(&c.common)
	c.DsarAPI = (*DsarAPIService)(&c.common)
